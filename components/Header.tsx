...
import { SunIcon, MoonIcon, HeartPulseIcon, HomeIcon, InformationCircleIcon, EnvelopeIcon } from './icons/Icons';
  ...
  const getNavClass = (view: View) =>
    `px-4 py-2 rounded-md text-sm font-medium transition-colors flex items-center gap-2 ${
      currentView === view
        ...
        : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 hover:text-primary-dark dark:hover:bg-gray-700'
    }`;
    ...
    <header className="bg-surface-light dark:bg-surface-dark shadow-md sticky top-0 z-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <button onClick={() => onNavigate('public')} className="flex items-center cursor-pointer">
          ...
          <nav className="hidden md:flex items-center space-x-4">
            ...
            <button onClick={() => onNavigate('about')} className={getNavClass('about')}>
              <InformationCircleIcon className="h-5 w-5" />
              <span>About Us</span>
            </button>
            <button onClick={() => onNavigate('contact')} className={getNavClass('contact')}>
        ...
        <div className="md:hidden flex justify-center space-x-2 pb-3">
             <button onClick={() => onNavigate('public')} className={getNavClass('public')}>
              <HomeIcon className="h-5 w-5" />
              <span>Home</span>
            </button>
