...
import { SunIcon, MoonIcon, BuildingLibraryIcon, UserIcon } from './icons/Icons';
  ...
  const getNavClass = (view: View) =>
    `px-4 py-2 rounded-md text-sm font-medium transition-colors ${
      currentView === view
        ...
        : 'text-gray-600 dark:text-gray-300 hover:bg-primary-light hover:text-primary-dark dark:hover:bg-surface-dark'
    }`;
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <BuildingLibraryIcon className="h-8 w-8 text-primary-dark" />
          ...
          <nav className="hidden md:flex items-center space-x-4">
            ...
            <button onClick={() => onNavigate('admin')} className={getNavClass('admin')}>
              Admin Panel
            </button>
          </nav>
          <div className="flex items-center">
